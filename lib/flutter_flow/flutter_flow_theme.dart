...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF072F26);
  late Color secondary = const Color(0xFFFED148);
  late Color tertiary = const Color(0xFFF7E6D1);
  late Color alternate = const Color(0xFFF0F0F0);
  late Color primaryText = const Color(0xFF072F26);
  late Color secondaryText = const Color(0xFF3D4648);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x004B39EF);
  late Color accent2 = const Color(0x0039D2C0);
  late Color accent3 = const Color(0x00EE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFF5EB5FD);
}
